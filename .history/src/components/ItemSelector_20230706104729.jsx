  ...
  const elements = [
    ...
    },
    {
      ...
      array: [
        ...
        { title: "CSS Flexbox", text: "Harnessing the power of CSS flexbox for flexible and responsive website layouts.", rating: "1.4" },
      ],
    },
    {
      name: "JavaScript",
      ...
      array: [
        { title: "DOM Manipulation", text: "Manipulating HTML elements dynamically using JavaScript for interactive web experiences.        ", rating: "4.5" },
        { title: "Promises", text: "Managing asynchronous operations efficiently with JavaScript promises for smoother execution.        ", rating: "2.2" },
        { title: "ES6 Syntax", text: "Embracing the latest features of ES6 syntax to write cleaner and more concise JavaScript code.        ", rating: "3.8" },
      ],
    },
    {
      name: "Data Science",

  ...
  return (
    <div className={navbarStyles.navbar}>
      ...
      <div className={navbarStyles.buttons}>
        <Button variant="contained" size="medium" sx={{ backgroundColor: "primary.dark", mr: 1 }}>
          Log in
        </Button>
        <Button variant="contained" sx={{ backgroundColor: "primary.light", color: "primary.dark", mr: 1 }}>
          Sign up
        </Button>

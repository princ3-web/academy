      ...
      {images.map((item, n) => (
        <div className={imageSliderStyles.slide} style={{ transform: `translateX(-${index * 100}%)` }}>
          ...
          <Box  p={3} className={imageSliderStyles.textBox} sx={{ width: 300, height: 200, backgroundColor: grey[100] }}>
            <Typography fontSize={14}>The latest in learning</Typography>
            <Typography>Log in for deals on courses and stay on top of the skills you need. Sale ends July 5.</Typography>
          </Box>
        </div>
      ))}

...
const MultipleItemCarousel = () => {
    ...
    const carouselItems = [
        ...
        <Paper key={10} className={classes.carouselItem}>
          <Typography>Item 7</Typography>
        </Paper>,
        <Paper key={11} className={classes.carouselItem}>
          <Typography>Item 7</Typography>
        </Paper>,
        <Paper key={12} className={classes.carouselItem}>
          <Typography>Item 7</Typography>
        </Paper>,
        <Paper key={13} className={classes.carouselItem}>
          <Typography>Item 7</Typography>
        </Paper>,
      ];

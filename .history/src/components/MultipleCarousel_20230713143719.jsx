    ...
    <Box sx={{ position: "relative", width: "100%" }}>
      ...
      >
        <IconButton onClick={handleScrollLeft} disabled={scrollAmount === 0}>
          <ArrowCircleLeft
            style={{ fontSize: "250%" }}
            sx={{ color: grey[50], filter: "drop-shadow(0px 0px 3px rgba(0, 0, 0, 0.5))" }}
          />
        </IconButton>
        <IconButton
        ...
        >
          <ArrowCircleRight style={{ fontSize: "250%" }} sx={{ color: grey[50], filter: "drop-shadow(0px 0px 3px rgba(0, 0, 0, 0.5))" }} />
        </IconButton>
      </Box>
    </Box>
  );

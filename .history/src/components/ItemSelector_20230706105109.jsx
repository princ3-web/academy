...
const ItemSelector = () => {
  ...
  const elements = [
    ...
    },
    {
      ...
      button: "Get Started",
      array: [
        { title: "Elastic Compute Cloud", text: "Deploying and managing scalable virtual servers on the AWS EC2 platform.", rating: "3.1" },
        { title: "Simple Storage Service", text: "Storing and retrieving data securely in the highly scalable AWS S3 storage service.", rating: "1.6" },
        { title: "Lambda Functions", text: "Building and deploying serverless functions for event-driven applications on AWS Lambda.        ", rating: "4.6" },
      ],
    },
    {
      name: "Drawing",

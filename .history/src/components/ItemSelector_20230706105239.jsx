...
const ItemSelector = () => {
  ...
  const elements = [
    ...
    },
    {
      ...
      array: [
        { title: "Perspective Drawing", text: "Creating realistic depth and dimension in drawings through perspective techniques.", rating: "2.3" },
        { title: "Figure Anatomy", text: "Understanding human anatomy to accurately depict figures and enhance character drawings.", rating: "3.5" },
        { title: "Shading Techniques", text: "Mastering various shading techniques to bring life and realism to drawings.", rating: "4.8" },
      ],
    },
  ];

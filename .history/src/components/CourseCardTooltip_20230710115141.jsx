...
const CourseCardTooltip = ({ display, placement }) => {
  return (
    ...
    >
      ...
      <Typography fontSize={12} fontWeight={600} color={teal[600]}>Updated February 2023</Typography>
      <Typography  fontSize={14} color={grey[600]}>9.5 total hours · All Levels · Subtitles</Typography>
      <Typography>

      ...
      <Box padding={4} border={1}>
        ...
        <Box>
          <Box>
            ...
            <Typography>Python And Flask Framework Complete Course For BeginnersBeginner to Expert Python And Flask.Start from the basics and go all the way to creating your own applications and gamesRating: 4.3 out of 51277 reviews12.5 total hours72 lecturesBeginnerCurrent price: zł59.99Original price: zł189.99</Typography>

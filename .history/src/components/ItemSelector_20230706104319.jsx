...
const ItemSelector = () => {
  ...
  const elements = [
    ...
    },
    {
      ...
      button: "Explore",
      array: [
        { title: "Pivot Tables", text: "Data Analysis Powerhouse - Unleashing Excel's analytical capabilities using pivot tables.
        ", rating: "4.3" },
        { title: "Conditional Formatting", text: "Explore advanced data analysis techniques.", rating: "1.8" },
        { title: "VLOOKUP Function", text: "Learn JavaScript for web development.", rating: "4.1" },
      ],
    },
    {

  ...
  const elements = [
    {
      ...
      button: "Start Now",
      array: [
        { title: "Excel", text: "Learn how to use Excel for data analysis.", rating: "4.7" },
        { title: "Web Development", text: "Learn the fundamentals of web development.", rating: "2.5" },
        { title: "JavaScript", text: "Learn JavaScript for web development.", rating: "3.9" },
      ],
    },
    {
      name: "Excel",
        ...
        <Box padding={4} border={1}>
          ...
          <Box display="flex">
            {elements[selectedItem].array.map((item) => (
              <CourseCard title={item.title} text={item.text} rating={3} />
            ))}
          </Box>
        </Box>
      }

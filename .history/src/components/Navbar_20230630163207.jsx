  ...
  return (
    <div className={navbarStyles.navbar}>
      ...
      <div className={navbarStyles.searchBar}>
        <img className={navbarStyles.icon} style={{height: ""}} src={navbarIcons[1].icon} alt="" />
      </div>
      ...
      <div className={navbarStyles.buttons}>
        ...
        <div className={navbarStyles.button} style={{ backgroundColor: "var(--gray-900)", color: "var(--gray-100)" }}>
          {buttons[1].name}
        </div>

  ...
  const elements = [
    {
      ...
      button: "Start Now",
      array: [
        { title: "Python decorators", text: "Enhance functions and classes with reusable and customizable features.
        ", rating: "4.7" },
        { title: "Asynchronous programming", text: "Learn the fundamentals of web development.", rating: "2.5" },
        { title: "Python data visualization", text: "Learn JavaScript for web development.", rating: "3.9" },
      ],
    },
    {
      name: "Excel",
      ...
      button: "Explore",
      array: [
        { title: "Excel", text: "Master advanced Excel functions and formulas.", rating: "4.3" },
        { title: "duupa", text: "Explore advanced data analysis techniques.", rating: "1.8" },
        { title: "JavaScript", text: "Learn JavaScript for web development.", rating: "4.1" },
      ],
    },
    {

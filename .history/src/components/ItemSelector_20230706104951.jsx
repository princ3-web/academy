...
const ItemSelector = () => {
  ...
  const elements = [
    ...
    },
    {
      ...
      button: "Explore Now",
      array: [
        { title: "Machine Learning Basics", text: "Understanding the fundamentals of machine learning for predictive modeling tasks.", rating: "3.3" },
        { title: "Data Visualization", text: "Communicating complex data patterns and trends through impactful visualizations.", rating: "4.9" },
        { title: "Exploratory Data Analysis", text: "Analyzing and exploring data to discover patterns, outliers, and relationships.        ", rating: "2.7" },
      ],
    },
    {
      name: "Amazon AWS",

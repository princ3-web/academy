  ...
  return (
    <Box paddingX={4} paddingY={4}>
      ...
      <Box padding={4} border={1}>
        <Typography fontWeight={600} fontSize={28}>Build websites and applications with Web Development</Typography>
        <Typography width={"65%"}>
        ...
        <Button variant="outlined" marginTop=>
          <Typography fontWeight={600}>Explore Web Development</Typography>

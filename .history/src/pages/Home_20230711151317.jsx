  ...
  return (
    <Box>
      ...
      <Box p={4}>
        ...
        <Box padding={2} border={"1px solid" + grey[600]}>
      ...
      <Box px={4} py={8} backgroundColor={grey[200]}>
        <Box backgroundColor={grey[100]} p={3} sx={{ position: "relative", width: "60%", left: "20%" }}>
          <MultipleCarousel elements={<OpinionCard />} />
        </Box>
      </Box>
    </Box>
  );

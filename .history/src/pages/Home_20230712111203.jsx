...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box px={4} py={8} backgroundColor={grey[200]} position={"relative"} display={"f"} justifyContent={"center"}>
        <Box backgroundColor={grey[100]} sx={{ position: "relative", width: "60vw", alignSelf:"center" }}>
